...
// void CreateAVL(BSTNode *&b,char str[])
// {
//     int taller;
//     int n=strlen(str);
//     for(int i=0;i<n;i++)
//     {
//         InsertAVL(b,str[i],taller);
//     }
// }
...
int main()
{
    ...
    printf(" 创建一棵AVL树:\n");
    printf("   第1步,插入16元素:");
    InsertAVL(b,16,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第2步,插入3元素:");
    InsertAVL(b,3,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第3步,插入7元素:");
    InsertAVL(b,7,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第4步,插入11元素:");
    InsertAVL(b,11,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第5步,插入9元素:");
    InsertAVL(b,9,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第6步,插入26元素:");
    InsertAVL(b,26,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第7步,插入18元素:");
    InsertAVL(b,18,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第8步,插入14元素:");
    InsertAVL(b,14,taller);
    DispBSTree(b);
    printf("\n");
    printf("   第9步,插入15元素:");
    InsertAVL(b,15,taller);
    DispBSTree(b);
    printf("\n");
    printf("   AVL:");
    DispBSTree(b);
